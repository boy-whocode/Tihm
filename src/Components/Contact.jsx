const Contact=()=>{
  ...
  <ul className="p-0">
    <li><a href="tel:+918696232306">
        <img className="w-100 h-100" src="./image/contact_icons/phone.png" alt />
      </a></li>
    <li><a target="_blank" href="https://wa.me/918696232306?text=I'm%20inquiring%20about%20the%20online%20registration">
    ...
    <li><a target="_blank" href="mailto:naamrahulsharma@gmail.com">
